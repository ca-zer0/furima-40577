...
RSpec.describe OrderForm, type: :model do
  ...
  context '登録できない場合' do
    ...
    it 'post_codeは『３桁ハイフン４桁』半角英数字でないと保存できないこと' do
      ...
      @order_form.valid?
      expect(@order_form.errors.full_messages).to include("Post code can't be blank. is invalid. Include hyphen(-)")
    end
    ...
    it 'phone_numberが9桁以下だと購入できないこと' do
      ...
      @order_form.valid?
      expect(@order_form.errors.full_messages).to include("Phone number can't be blank. is invalid")
    end
